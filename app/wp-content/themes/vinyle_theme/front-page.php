            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    <?php if ($query->have_posts()) : $query->the_post(); ?>
                        ...
                        <div class="trait"></div>
                        <a class="paragraphe" href="<?php the_permalink(); ?>"><?php the_excerpt(); ?></a>
                    <?php endif; ?>
                </div>
            </div>
...
<section class="map_form">
    <div class="container-fluid pr-0 pl-0 mr-0 ml-0">
        <div class="container">
            <div class="row">
                <form class="col-6" method="POST" action="#" id="formulaire" class="needs-validation" novalidate>
                    ...
                    <div class="form_input">
                        ...
                        <textarea class="form-control" id="message" placeholder="Message" name="message" rows="6" required></textarea>
                    </div>
